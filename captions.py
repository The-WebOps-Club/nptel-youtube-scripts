...
if __name__ == "__main__":
  ...
  argparser.add_argument('--files', help='location of transcript files')
  args = argparser.parse_args()
  ...
  #      
    ...
    with open(args.data, 'rb') as f:
      reader = csv.reader(f)
      for row in reader:
        transcript_file = row[0]
        video_id = row[1]
        id = upload_caption(youtube, video_id, 'en', 'NPTEL Official', os.path.join(args.files, transcript_file))
  	update_caption(youtube, id, os.path.join(args.files, transcript_file))      
